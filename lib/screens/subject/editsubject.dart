...
class _EditSubjectPageState extends State<EditSubjectPage> {
  ...
  Future<void> fetchSubjectInfo() async {
    final url = Uri.parse(
      'http://localhost:443/subject/info?subject_id=${widget.subjectId}',
    );
  ...
  Future<void> fetchProfessorName() async {
    final url = Uri.parse(
      'http://localhost:443/prof/info?pro_id=$_proId',
    );
    final response = await http.get(url);
  ...
  Future<void> modifySubjectInfo() async {
    final url = Uri.parse('http://localhost:443/subject/modify');
  ...
  Future<void> deleteSubjectInfo() async {
    final url = Uri.parse('http://localhost:443/subject/delete');
