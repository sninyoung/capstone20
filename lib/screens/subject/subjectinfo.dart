...
class _SubjectInfoState extends State<SubjectInfo> {
  ...
  Future<void> fetchSubjectById() async {
    final response = await http.get(Uri.parse('http://localhost:443/subject/info?subject_id=${widget.subjectId}'));
  ...
  Future<void> fetchProfessorById(int proId) async {
    final response = await http.get(Uri.parse('http://localhost:443/prof/info?pro_id=$proId'));
