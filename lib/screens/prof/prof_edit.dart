...
class _EditProfessorPageState extends State<EditProfessorPage> {
  ...
  Future<void> fetchProfessorInfo() async {
    final url = Uri.parse(
      'http://localhost:443/prof/info?pro_id=${widget.professorId}',
    );
  ...
  Future<void> modifyProfessorInfo() async {
    final url = Uri.parse('http://localhost:443/prof/modify');
  ...
  Future<void> deleteProfessorInfo() async {
    final url = Uri.parse('http://localhost:443/prof/delete');
